...
el string está en strPtr+frame.wSz y tiene el formato .string "[el string]"
        ...
        fun getRealString(strPtr:int):string =
            let
              ...
              val (str2,delFuente) = case str of
                  #"."::( #"l"::( #"o"::( #"n"::( #"g"::_)))) => (explode (loadString (strPtr + frame.wSz)),true)
                | _ => (str,false)
